  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-g>ay-200">
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <select name="age">
                          ...
                          <option value="2" @if($contact->gender == 2) selected @endif>20歳~29歳</option>
                          <option value="3" @if($contact->gender == 3) selected @endif>30歳~39歳</option>
                          <option value="4" @if($contact->gender == 4) selected @endif>40歳~49歳</option>
                          <option value="5" @if($contact->gender == 5) selected @endif>50歳~59歳</option>
